...
import libs.nnet3.train.chain_objf.acoustic_model_olcmvn as chain_lib
...
def get_args():
    ...
    parser.add_argument("--dir", type=str, required=True,
                        ...
                        "all other files.")
    parser.add_argument("--online-cmvn", dest='online_cmvn', default=True,
                                 action=common_lib.StrToBoolAction,
                                 choices=["true", "false"],
                                 help="use online cmvn or not")
