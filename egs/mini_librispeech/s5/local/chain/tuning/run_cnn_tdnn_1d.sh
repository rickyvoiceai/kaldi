...
# run_cnn_tdnn_1d.sh is modified from run_cnn_tdnn_1a.sh, but with CNN-TDNN-LSTM and spectrum augmentation, segment cmvn
...
# Not testing online decoding because we use full-utterance cmvn
