...
# run_cnn_tdnn_1g.sh is modified from run_cnn_tdnn_1a.sh, but with attention and multiple stream, spectrum augmentation and online cmvn
...
if [ $stage -le 13 ]; then
  ...
  tdnnf-layer name=tdnnf7 $tdnnf_first_opts dim=320 bottleneck-dim=192 time-stride=0
  tdnnf-layer name=tdnnf8 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=3
  tdnnf-layer name=tdnnf9 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=3
  tdnnf-layer name=tdnnf10 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=3
  tdnnf-layer name=tdnnf11 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=3
  tdnnf-layer name=tdnnf12 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=3
  tdnnf-layer name=tdnnf13 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=3
  tdnnf-layer name=tdnnf14 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=3
  tdnnf-layer name=tdnnf15 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=3

  tdnnf-layer name=tdnnf16 input=cnn6 $tdnnf_first_opts dim=320 bottleneck-dim=192 time-stride=0
  tdnnf-layer name=tdnnf17 input=tdnnf16 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=2
  tdnnf-layer name=tdnnf18 input=tdnnf17 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=2
  tdnnf-layer name=tdnnf19 input=tdnnf18 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=2
  tdnnf-layer name=tdnnf20 input=tdnnf19 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=2
  tdnnf-layer name=tdnnf21 input=tdnnf20 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=2
  tdnnf-layer name=tdnnf22 input=tdnnf21 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=2
  tdnnf-layer name=tdnnf23 input=tdnnf22 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=2
  tdnnf-layer name=tdnnf24 input=tdnnf23 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=2
  ...
  tdnnf-layer name=tdnnf25 input=cnn6 $tdnnf_first_opts dim=320 bottleneck-dim=192 time-stride=0
  tdnnf-layer name=tdnnf26 input=tdnnf25 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=1
  tdnnf-layer name=tdnnf27 input=tdnnf26 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=1
  tdnnf-layer name=tdnnf28 input=tdnnf27 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=2
  tdnnf-layer name=tdnnf29 input=tdnnf28 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=2
  tdnnf-layer name=tdnnf30 input=tdnnf29 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=3
  tdnnf-layer name=tdnnf31 input=tdnnf30 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=3
  tdnnf-layer name=tdnnf32 input=tdnnf31 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=3
  tdnnf-layer name=tdnnf33 input=tdnnf32 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=3
  tdnnf-layer name=tdnnf34 input=tdnnf33 $tdnnf_opts dim=320 bottleneck-dim=112 time-stride=3
