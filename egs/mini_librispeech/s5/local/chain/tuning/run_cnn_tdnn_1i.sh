...
# run_cnn_tdnn_1i.sh is modified from run_cnn_tdnn_1a.sh, but with attention, multiple stream, specturm augmentation, without dropout

# ./local/chain/compare_wer.sh --online exp/chain/cnn_tdnn1j_sp exp/chain/cnn_tdnn1i_sp
# System                cnn_tdnn1j_sp cnn_tdnn1i_sp
